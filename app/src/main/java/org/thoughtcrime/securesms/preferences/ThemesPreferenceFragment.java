...
public class ThemesPreferenceFragment extends ListSummaryPreferenceFragment {

    @SuppressWarnings("unused")
    private static final String TAG = ThemesPreferenceFragment.class.getSimpleName();
